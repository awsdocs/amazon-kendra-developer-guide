...
+ [Creating a data source](data-source.md)
   + [Data sources](data-sources.md)
      ...
      + [Amazon WorkDocs](data-source-workdocs.md)
      ...
      + [Custom data source](data-source-custom.md)
...
+ [Amazon Kendra Intelligent Ranking](intelligent-rerank.md)
...
+ [API reference](API_Reference.md)
   + [Actions](API_Operations.md)
      + [Amazon Kendra](API_Operations_Amazon_Kendra.md)
      ...
      + [Amazon Kendra Intelligent Ranking](API_Operations_Amazon_Kendra_Intelligent_Ranking.md)
   ...
   + [Data Types](API_Types.md)
      + [Amazon Kendra](API_Types_Amazon_Kendra.md)
      ...
      + [Amazon Kendra Intelligent Ranking](API_Types_Amazon_Kendra_Intelligent_Ranking.md)
