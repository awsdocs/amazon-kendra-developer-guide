...
To connect Amazon Kendra to your Amazon FSx data source, you must provide the necessary details of your Amazon FSx data source so that Amazon Kendra can access your data\. If you have not yet configured Amazon FSx for Amazon Kendra see [Prerequisites](#prerequisites-fsx)\.
...
1. On the **Add data source** page, choose **Amazon FSx connector**, and then choose **Add data source**\.
...
1. On the **Configure sync settings** page, enter the following information:
   ...
   1. In **Sync run schedule**, for **Frequency**—Choose how often Amazon Kendra should sync with your data source\.
